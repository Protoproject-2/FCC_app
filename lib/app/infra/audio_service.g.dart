...
@ProviderFor(KeywordDetected)
const keywordDetectedProvider = KeywordDetectedProvider._();

final class KeywordDetectedProvider
    extends $NotifierProvider<KeywordDetected, bool> {
  const KeywordDetectedProvider._()
      : super(
          from: null,
          argument: null,
          retry: null,
          name: r'keywordDetectedProvider',
          isAutoDispose: true,
          dependencies: null,
          $allTransitiveDependencies: null,
        );
  ...
  @override
  String debugGetCreateSourceHash() => _$keywordDetectedHash();

  @$internal
  @override
  KeywordDetected create() => KeywordDetected();
...
String _$keywordDetectedHash() => r'c49f967b185cdb9a4feee77098a7724233956e4b';

abstract class _$KeywordDetected extends $Notifier<bool> {
  bool build();
  @$mustCallSuper
  @override
  void runBuild() {
